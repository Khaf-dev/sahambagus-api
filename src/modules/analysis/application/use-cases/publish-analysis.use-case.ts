...
@Injectable()
export class PublishAnalysisUseCase {
  constructor(
  ...
  async execute(analysisId: string, editorId?: string): Promise<AnalysisResponseDto> {
    // 1. Find analysis
    ...
    // 2. Publish (entity validates status)
    analysis.publish(editorId || 'temp-editor-id');
